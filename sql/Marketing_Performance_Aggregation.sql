...
-- ============================================================================
-- SETUP NOTE:
-- The paths below are relative to a "data/" folder at the project root
-- (i.e. marketing-campaign-analytics/data/*.csv). Download the four CSV
-- files from the Kaggle source listed in the README and place them there.
-- Run this script from the project root so the relative paths resolve
-- correctly, e.g.:
--     mysql --local-infile=1 -u root -p < sql/Marketing_Performance_Aggregation.sql
-- ============================================================================
...
LOAD DATA LOCAL INFILE 'data/client_first_purchase_date.csv'
...
LOAD DATA LOCAL INFILE 'data/holidays.csv'
INTO TABLE holidays
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'data/messages-demo.csv'
